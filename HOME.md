...
- other:
	- [Settings Profiles](https://github.com/4Source/settings-profiles-obsidian-plugin) (apply plugins from this vault to any other!)
...
- editor:
	...
	- [External File Linker](https://github.com/Kay607/obsidian-pathlinker), …
- performed badly:
	- ~~[File Ignore](https://github.com/Feng6611/Obsidian-File-Ignore)~~ ("show files" doesn't work)

...
- editor:
	- [Friend Tracker](obsidian://show-plugin?id=friend-tracker), [Keyshots](https://github.com/KrazyManJ/obsidian-keyshots), …
- files:
...
- performed badly:
	...
	- ~~[Enhanced Read Mode Control](https://github.com/mathe00/obsidian-enhanced-read-mode-control)~~ (no `main.js` file), …

...
- hotkeys:
	...
	- replace [Jump To Link](https://github.com/mrjackphil/obsidian-jump-to-link) with [Vimium](https://github.com/karstenpedersen/obsidian-vimium) (if the latter supports links), …
- files:
	- [CSV Lite](https://github.com/LIUBINfighter/csv-lite), [Come Down](https://github.com/mntno/obsidian-come-down),
...
- other:
	- [Relay](https://github.com/no-instructions/relay) (collaboration), …
...
- performed badly:
	...
	- ~~[Enhanced Read Mode Control](https://github.com/mathe00/obsidian-enhanced-read-mode-control)~~ (no `main.js` file) VS [Note Locker](https://github.com/Felvesthe/note-locker)
